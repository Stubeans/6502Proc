...
export class MMU extends Hardware{
    ...
    constructor(MEMORY: Memory) {
        super(0, "MMU");
        this._MEMORY = MEMORY;
        this.writeImm(0x0000, 0xA2);
        this.writeImm(0x0001, 0x02);
        this.writeImm(0x0002, 0xA0);
        this.writeImm(0x0003, 0x48);
        this.writeImm(0x0004, 0xFF);
        this.writeImm(0x0005, 0xA0);
        this.writeImm(0x0006, 0x65);
        this.writeImm(0x0007, 0xFF);
        this.writeImm(0x0008, 0xA0);
        this.writeImm(0x0009, 0x6C);
        this.writeImm(0x000A, 0xFF);
        this.writeImm(0x000B, 0xA0);
        this.writeImm(0x000C, 0x6C);
        this.writeImm(0x000D, 0xFF);
        this.writeImm(0x000E, 0xA0);
        this.writeImm(0x000F, 0x6F);
        this.writeImm(0x0010, 0xFF);
        this.writeImm(0x0011, 0xA0);
        this.writeImm(0x0012, 0x21);
        this.writeImm(0x0013, 0xFF);
